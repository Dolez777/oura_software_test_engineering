...
def generate_chaos(data: dict) -> dict:
    ...
    if chaos_type == "500":
        raise HTTPException(status_code=500, detail="Internal Server Error (Chaos Mode)")
...
async def get_readiness(chaos: bool = False):
